...
roles = Role.create([{ name: 'admin', name: 'applicant'}])
# user = User.create(email: 'oscar@example.com')
...
applicant_user = User.create(email: 'user@example.com')
applicant_user.roles << applicant_role

data.each do |k,v|
  imgs = v.map {|i| Image.create({location: i})}
  question = Question.create(title: k, correct_answer: imgs.first.id)
...
# first_question = Question.create(title: "365 Organic Frosted Flakes Cereal", correct_answer: 1)
# first_image_set = Image.create([
#     { location: "https://d2lnr5mha7bycj.cloudfront.net/itemimage/image/12215-eaac44d114cb00be4e3ecc26e0cf39be.jpg" },
#     { location: "https://d2lnr5mha7bycj.cloudfront.net/itemimage/image/12217-9186e76a368e196da3bc4b655d02ca30.jpg" },
#     { location: "https://d2lnr5mha7bycj.cloudfront.net/itemimage/image/12212-0e2a15ef92d3a7b48ef53c4162b3c836.jpg" },
#     { location: "https://d2lnr5mha7bycj.cloudfront.net/itemimage/image/12189-97c5e14e27d6344a34a9c9d903e0dc5a.jpg" } 
#   ])